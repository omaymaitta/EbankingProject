...
public class BankAccountServiceImpl implements BankAccountService {
    ...
    @Override
    public CurrentBankAccountDTO saveCurrentBankAccount(double initialBalance, Long overDraft, long customerId) throws CustomerNotFoundException {
    ...
    @Override
    public SavingBankAccountDTO saveSavingBankAccount(double initialBalance, Long interestRate, long customerId) throws CustomerNotFoundException {
        Customer customer = customerRepository.findById(customerId).orElse(null);
